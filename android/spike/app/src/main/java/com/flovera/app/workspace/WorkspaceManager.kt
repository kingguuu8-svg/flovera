...
data class FloveraCapabilities(
  ...
  val androidCommandRuntimeMode: String = "app_owned_permission_status_and_system_intents",
  val androidCommandSupportedSubcommands: List<String> = listOf(
    "android app info",
    "android permission status",
    "android permission open <permission-id>",
    "android intent open <permission-id>",
  ),
  val androidPermissionConsole: Boolean = true,
  val androidPermissionGrantEntry: String = "main_menu_permissions_panel",
