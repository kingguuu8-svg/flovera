...
data class FloveraCapabilities(
  ...
  val officeOoxmlRuntimeMode: String = "lightweight_zip_xml_workspace_command",
  ...
  val officeOoxmlSupportedCommands: List<String> = listOf(
    ...
    "flovera office text <path>",
    "flovera office replace <path> --find <text> --replace <text> [--output <path>]",
  ),
  val officeOoxmlComplexLibraryTargets: List<String> = listOf("docx4j", "apache-poi"),
  val officeOoxmlComplexEditingStatus: String = "planned_jvm_worker_adaptation",
