...
data class FloveraCapabilities(
  ...
  val artifactInspectFormats: List<String> = listOf("json", "html", "docx", "xlsx", "pptx", "pdf", "png", "jpg", "jpeg", "webp", "text"),
  ...
  val workspaceCommandSupportedCommands: List<String> = listOf("python", "python3", "groovy", "git", "android", "flovera"),
  val workspaceCommandProfiles: List<String> = listOf("python", "groovy", "git", "android", "flovera-script", "flovera-office"),
  val workspaceAutomationScripts: Boolean = true,
  val workspaceAutomationScriptPath: String = ".flovera/scripts",
  ...
  val officeSuiteSkillId: String = "flovera-office-suite",
  val officeDocumentCreationPipelines: Map<String, String> = mapOf(
    "xlsx" to "openpyxl",
    "docx" to "python-docx",
    "pptx" to "python-pptx-with-android-pil-compatibility",
    "pdf" to "fpdf2-with-android-cjk-font",
  ),
  val officeDocumentCreationMode: String = "format_routed_android_compatible_engines",
  ...
  val officeOoxmlSupportedCommands: List<String> = listOf(
    ...
    "flovera office text <path> [--backend auto|light|poi]",
    "flovera office replace <path> --find <text> --replace <text> [--output <path>] [--backend auto|light|poi]",
  ),
  ...
  val officeOoxmlFallbackBackend: String = "lightweight_zip_xml",
  val officeOoxmlComplexEditingStatus: String = "available_as_structural_backend_not_full_office_renderer",
  val gitCommandRuntime: Boolean = true,
  val gitCommandRuntimeMode: String = "embedded_jgit_local_workspace",
  val gitCommandSupportedSubcommands: List<String> = listOf("init", "status", "diff", "log", "show", "branch", "add", "commit"),
  val gitCommandRemoteOperations: Boolean = false,
  val androidCommandRuntime: Boolean = true,
  ...
  val androidCommandSupportedSubcommands: List<String> = listOf(
    ...
    "android microphone record",
    "android location current",
    "android contacts list|search|create|delete",
    "android calendar calendars|events|create|delete",
    "android media list|import",
    "android bluetooth paired|scan",
    "android overlay show|hide",
    "android storage list|import",
    "android package install",
    "android alarm schedule|cancel",
    "android network get",
  ...
  val androidDesktopOperation: Boolean = true,
  val androidDesktopOperationMode: String = "accessibility_semantic_first",
  val androidDesktopTaskPersistence: Boolean = true,
  val androidDesktopActionIdempotency: Boolean = true,
  val androidDesktopPostActionVerification: Boolean = true,
  val androidDesktopRuntimeFeedback: Boolean = true,
  val androidDesktopCompletionStrongFeedback: Boolean = true,
  val androidDesktopOcrObservation: Boolean = true,
  val androidDesktopOcrEngine: String = "mlkit_text_recognition_chinese",
  val androidDesktopOcrSemanticFusion: Boolean = true,
  val androidDesktopOcrTextSelector: Boolean = true,
  val androidDesktopOcrPostActionVerification: Boolean = true,
  val androidDesktopSemanticClick: Boolean = true,
  ...
  val androidDesktopFailureDiagnosisPath: String = ".flovera/logs/ui-diagnosis",
  val androidDesktopInspectFilters: Boolean = true,
  val androidDesktopAccessibilityDiagnosis: Boolean = true,
  val androidDesktopScreenshotOutput: Boolean = true,
  val androidDesktopScreenshotVisionInput: Boolean = false,
  val androidPermissionChecksBeforeAction: Boolean = true,
  val androidBinaryOutputsToWorkspace: Boolean = true,
  val androidPermissionConsole: Boolean = true,
  val androidPermissionGrantEntry: String = "main_menu_permissions_panel_grant_all",
  val androidRuntimePermissionBatchRequest: Boolean = true,
  val androidSpecialPermissionSequentialFlow: Boolean = true,
  val androidPermissionIds: List<String> = listOf(
    "notifications",
    "camera",
    "microphone",
    "fine_location",
  ...
  val jvmBuildScheduler: Boolean = true,
  val jvmBuildSchedulerMode: String = "serialized_throttled_checkpointed_cache",
  val jvmBuildProgressLogPath: String = ".flovera/logs/jvm-build.jsonl",
  val jvmBuildStatePath: String = ".flovera/runtime/jvm-artifacts/build-state.json",
  val jvmBuildCancelFlagPath: String = ".flovera/runtime/jvm-artifacts/cancel.flag",
  val jvmBuildCancelFlagMode: String = "one_shot_consumed",
  val jvmBuildErrorClassification: Boolean = true,
  val jvmLibraryDexMode: String = "per_jar_resource_preserving_dex_jar",
  val jvmLibraryResourcesPreserved: Boolean = true,
  val jvmMavenConfigOverrideEnv: String = "FLOVERA_JVM_MAVEN_CONFIG",
  ...
  val customOpenAICompatibleProvider: Boolean = false,
  val openRouterRouting: Boolean = false,
  val customUrlRouting: Boolean = false,
  ...
  val providerRequestHooks: Boolean = false,
  val customRequestBody: Boolean = false,
