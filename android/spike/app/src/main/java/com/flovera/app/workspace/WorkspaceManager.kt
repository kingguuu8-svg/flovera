...
data class FloveraCapabilities(
  ...
  val workspaceCommandSupportedCommands: List<String> = listOf("python", "python3", "groovy", "git", "android"),
  val workspaceCommandProfiles: List<String> = listOf("python", "groovy", "git", "android"),
