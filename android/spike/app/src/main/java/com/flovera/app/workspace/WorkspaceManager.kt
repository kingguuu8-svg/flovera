...
data class FloveraCapabilities(
  ...
  val officeOoxmlRuntimeMode: String = "lightweight_zip_xml_with_runtime_only_poi_docx4j_backends",
  ...
  val officeOoxmlSupportedCommands: List<String> = listOf(
    ...
    "flovera office text <path> [--backend auto|light|poi|docx4j]",
    "flovera office replace <path> --find <text> --replace <text> [--output <path>] [--backend auto|light|poi|docx4j]",
  ),
  val officeOoxmlHeavyBackends: List<String> = listOf("apache-poi", "docx4j"),
