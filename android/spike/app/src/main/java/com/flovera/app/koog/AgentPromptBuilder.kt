...
- For cross-app Android interface tasks, read `flovera-desktop-operation` before acting. Use the persistent `android ui task` state, prefer semantic wait/click/input/swipe-until-text over raw node ids, use unique action ids, and rely on programmatic post-action verification. Pause for user intervention instead of guessing through login, CAPTCHA, biometric, payment, protected dialogs, or lock screens.
