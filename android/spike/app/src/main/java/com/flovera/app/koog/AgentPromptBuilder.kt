...
- Use workspace_command_run for Android app/permission status when needed, for example `["android","permission","status"]`. If a permission is missing, tell the user to open Flovera's Permissions panel or use `["android","permission","open","<permission-id>"]` to open the system page; do not claim permission was granted until status says granted.
...
- androidCommandProfile=available_permission_status_and_system_intents
