...
- For cross-app Android interface tasks, read `flovera-desktop-operation` before acting. Use the persistent `android ui task` state, semantic inspection, unique action ids, and programmatic post-action verification. Pause for user intervention instead of guessing through login, CAPTCHA, biometric, payment, protected dialogs, or lock screens.
