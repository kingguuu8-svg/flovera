...
object ModelProviderCatalog {
  ...
  val providers = listOf(
    ...
    ModelProviderSpec(
      ...
      apiKeyLabel = "External Copilot ACP process",
      defaultModel = "copilot-acp",
      suggestedModels = listOf("copilot-acp"),
      llmProvider = LLMProvider.OpenAI,
      transport = ProviderTransport.FloveraExternalProcess,
      aliases = setOf("github-copilot-acp", "copilot-acp-agent"),
      baseUrl = "acp://copilot",
      authType = ProviderAuthType.ExternalProcess,
      supportsHealthCheck = false,
      defaultContext = hermesContext(200_000),
    ),
    ModelProviderSpec(
    ...
    ModelProviderSpec(
      ...
      apiKeyLabel = "Google OAuth access token",
      defaultModel = "gemini-3-flash-preview",
      suggestedModels = listOf(
        "gemini-3-flash-preview",
        "gemini-3-pro-preview",
      ...
      llmProvider = LLMProvider.Google,
      transport = ProviderTransport.FloveraGoogleCloudCodeAssist,
      aliases = setOf("gemini-cli", "gemini-oauth"),
